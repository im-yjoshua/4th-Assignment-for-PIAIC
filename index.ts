...
});
{
  ...
  
  {
    console.log("\n\t\t\tAssignment 4\n");
    console.log(
      "Develop a program that determines the day of the week. From number 1 to 5 it should print day name Monday to Friday respectively and for 6 it should print weekend. Do it using switch statement.\n"
    );

    rl.question("Enter a number (1-6): ", (numInput) => {
      var dayInput: string = numInput;
  ...
  {
    console.log(
      "Try making ATM machine that matches pin and account number in it. If matches then user can withdraw amount. And if he or she hasn't sufficient balance show them a message. Show message for wrong acocount number and wrong pin separately."
    );
          ...
          switch (pin) {
            case "1234":
              ...
              rl.question(
                ...
                (amountInput) => {
                  var amount: string = amountInput;

                  // {amount} should be less than or equal to 50,000
                  if (Number(amount) <= balanceInAccount) {
                    if (Number(amount) >= 100 && Number(amount) <= 10000) {
                      var newBalance: number = balanceInAccount - Number(amount);
                      console.log(
                        `Please wait while we process your transaction, ${users_name}`
                      );
                      console.log(
                        `Your transaction was successful. Your remaining balance is: Rs.${newBalance}`
                      );
                      console.log(
                        `Thank you for using our service, ${users_name}!`
                      );
                    } else {
                    ...
                    console.log(
                      `Unfortunately, your account has insufficient funds, ${users_name}!`
                    );
                  }
                  rl.close();
                }
  ...
  {
    console.log(
      'Write a ts program that prints message like "Good Morning" etc depending on time use hours only for now. Do it with both if else and switch statement\n'
    );

    const time = new Date();
    const hours = time.getHours();
    var name: string = "Imran Khan";
  ...
  rl.question("Enter a number (0-20): ", (numInput) => {
    ...
    if (Number(classInput) >= 0 && Number(classInput) <= 20) {
      ...
      if (Number(classInput) === 0) {
        ...
        console.log(
          `It is ${classname} and lies within the Intermidiate section.`
        );
        ...
        case 20:
          ...
          switch (Number(classInput)) {
            case 0:
              classname = "Playgroup";
              console.log(
                `It is ${classname} and lies within the Playgroup section.`
              );
              break;
            case 1:
              classname = "1st Class";
              console.log(
                `It is ${classname} and lies within the Primary section.`
              );
              break;
            case 2:
              classname = "2nd Class";
          ...
          switch (Number(classInput)) {
            case 4:
              classname = "4th Class";
              console.log(
                `It is ${classname} and lies within the Middle section.`
              );
              break;
            case 5:
              classname = "5th Class";
          ...
          switch (Number(classInput)) {
            case 9:
              classname = "9th Class";
              console.log(
                `It is ${classname} and lies within the Matric section.`
              );
              break;
            case 10:
              classname = "10th Class";
          ...
          switch (Number(classInput)) {
            case 13:
              classname = "13th Class";
              console.log(
                `It is ${classname} and lies within the Bachelor's section.`
              );
              break;
            case 14:
              classname = "14th Class";
          ...
          switch (Number(classInput)) {
            case 15:
              classname = "15th Class";
              console.log(
                `It is ${classname} and lies within the Masters section.`
              );
              break;
            case 16:
              classname = "16th Class";
          ...
          switch (Number(classInput)) {
            case 17:
              classname = "17th Class";
              console.log(
                `It is ${classname} and lies within the M-Phil section.`
              );
              break;
            case 18:
              classname = "18th Class";
        ...
        rl.question("Enter third number: ", (numInput3) => {
          ...
          rl.question("Enter fourth number: ", (numInput4) => {
            ...
            rl.question("Enter fifth number: ", (numInput5) => {
              ...
              function checkifNumber(numbers: number[]): number[] | undefined {
